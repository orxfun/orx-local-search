// use crate::{criteria::duration::DurationMatrix, tour::Tour, tour_cost::TourCost, tsp::Tsp};
...
//     ) -> Option<<Self::Objective as orx_local_search::Objective>::Unit> {
//         todo!()
//     }
// }
